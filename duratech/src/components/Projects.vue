<template>
<p class="text-center" id="title" >PROJECTS</p>
<p class="text-center" id="campaign" > Our Campaign </p>
...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p style="font-weight: bold; font-size: 40px;">Join Our Event & Helping us by our Donation</p>
            <p style="opacity: 0.5; font-weight: bold; font-size: 16px;">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
